...
use App\Http\Controllers\CountryPhoneNumberController;
...
Route::POST('/country_phone_code/add',[CountryPhoneNumberController::class,'add']);
Route::get('/advantages/all',[AdvantageController::class,'all']);
Route::get('/country_phone_code/all',[CountryPhoneNumberController::class,'all']);
